...
<head>
  ...
  <title>Portfolio Details - Saley Inc</title>
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Saley Inc.</a></h1>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong>: Dsign</li>
                <li><strong>Copyright</strong>: Saley Icn.</li>
                <li><strong>Project date</strong>: 01 March, 2020</li>
                <li><strong>Project URL</strong>: <a href="#">www.example.com</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>This is The Detailed Portfolio Design </h2>
              <p>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="inde.php">Marketing</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <p>Follow Us On Our Social Media, For New Updates <br> Saley Inc <br> YOUR GATEWAY TO DIGITIZATION </p>
