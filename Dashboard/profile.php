                ...
                <form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="lname" class="form-control" placeholder="Last Name" value="Andrew">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>Role</label>
                        <input type="text" name="position" class="form-control" placeholder="Country" value="Andrew">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label>Phone</label>
                        <input type="number" name='phone' class="form-control" placeholder="ZIP Code">
                      </div>
                    </div>
                  </div>
                  <div class="row">
